...
function getMockJobs(): Job[] {
  return [
    ...
    },
    {
      ...
      requirements: ['3+ years of experience', 'Full stack expertise'],
      status: 'active',
    ...
    },
    {
      ...
      requirements: ['3+ years of product design experience', 'Strong portfolio'],
      status: 'active',
    ...
    },
    {
      ...
      requirements: ['5+ years in DevOps', 'AWS certification preferred'],
      status: 'active',
    ...
    },
    {
      ...
      requirements: ['1+ year of experience or strong internship', 'CS degree preferred'],
      status: 'active',
    ...
    },
    {
      ...
      requirements: ['3+ years in data science', 'Masters in related field preferred'],
      status: 'active',
